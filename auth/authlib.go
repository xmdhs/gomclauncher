...
const (
	Authlibversion = "1.1.35"
	Authlibsha1    = "3a465b6fdd0cead65364e1fe57da58680e77c2f9"
)

var Authliburls = []string{
	"https://download.mcbbs.net/mirrors/authlib-injector/artifact/35/authlib-injector-1.1.35.jar",
